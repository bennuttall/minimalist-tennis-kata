...
class Test(unittest.TestCase):
    ...
    def test_player_one_scores_from_own_advantage_player_one_wins(self):
        game = Game()
        game.point_scored(1)
        game.point_scored(1)
        game.point_scored(1)
    ...
    def test_player_two_scores_from_own_advantage_player_two_wins(self):
        game = Game()
        game.point_scored(1)
        game.point_scored(1)
        game.point_scored(1)
        ...
        self.assertEqual(game.get_score(), 'Deuce')
        game.point_scored(2)
        self.assertEqual(game.get_score(), 'Advantage Player 2')
        game.point_scored(2)
        self.assertEqual(game.get_score(), 'Player 2 Wins')

    def test_player_scores_from_other_advantage_score_goes_back_to_deuce(self):
        game = Game()
        game.point_scored(1)
        game.point_scored(1)
        game.point_scored(1)
